...
def test_email():
    ...
    try:
        ...
        test_email_address = data.get('email', os.getenv('EMAIL_USER'))
        ...
        connection_ok, connection_msg = email_service.test_email_connection()
        if not connection_ok:
            return jsonify({
                ...
                'data': {
                    ...
                    'suggestion': 'Check your EMAIL_USER and EMAIL_PASS in .env file. Make sure EMAIL_PASS is a Gmail App Password (16 characters, no spaces).'
                }
            }), 500
        
        # Send a test email
        email_sent, message = email_service.send_welcome_email(
