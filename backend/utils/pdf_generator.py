...
class ComplaintPDFGenerator:
    ...
    def generate_complaint_pdf(self, complaint_data):
        ...
        try:
            ...
            if complaint_data.get('estimated_completion_time'):
                formatted_time = complaint_data.get('estimated_completion_time_formatted', 
                    f"{complaint_data['estimated_completion_time']} minutes")
                complaint_details.append(['Estimated Completion Time', formatted_time])
